  ...
  return (
    <div className="flex justify-between mt-[43px] mb-[40px] mr-[111px] ml-[104px] mx-auto items-center">
      ...
      <nav className="flex justify-between w-[53%]">
        <a href={paths.ABOUT} target="_blank" className="text-green text-sm">
          Hakkımızda
        </a>
        <a href={paths.JURI} target="_blank" className="text-green text-sm">
          Juri - Yarışma Yazılımı
        </a>
        <a href={paths.NINJA} target="_blank" className="text-green text-sm">
          Word Ninja
        </a>
        <a href={paths.PYRAMIDS} target="_blank" className="text-green text-sm">
          Word Pyramids
        </a>
      </nav>
